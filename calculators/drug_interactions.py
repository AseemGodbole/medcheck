...
⚕️ For educational use only. Not a substitute for clinical judgment.
"""
...
INTERACTIONS: list[Interaction] = [
    ...
    Interaction(
        ...
        management="Reduce warfarin dose empirically by 30–50% when amiodarone initiated. Monitor INR weekly for several weeks. Note: amiodarone effect persists weeks–months after it is stopped (very long half-life).",
        aliases_a=["warfarin", "coumadin"],
    ...
    Interaction(
        ...
        effect="Markedly elevated INR within 1–3 days; serious bleeding",
        management="Empirically reduce warfarin dose by 25–50%. Monitor INR every 1–2 days during fluconazole course and after completion. Consider topical antifungal alternatives.",
        aliases_a=["warfarin", "coumadin"],
    ...
    Interaction(
        ...
        management="Avoid if possible. If essential, increase warfarin dose significantly (may need to double or triple); monitor INR every 1–2 days. After rifampicin stopped, reduce warfarin promptly or risk major bleeding.",
        aliases_a=["warfarin", "coumadin"],
    ...
    Interaction(
        ...
        management="Monitor INR weekly when carbamazepine started or dose changed. May need warfarin dose increase of 30–50%.",
        aliases_a=["warfarin", "coumadin"],
    ...
    Interaction(
        ...
        management="Reduce digoxin dose by 33–50% when verapamil added. Monitor digoxin levels, heart rate, and ECG.",
        aliases_a=["digoxin", "lanoxin"],
    ...
    Interaction(
        ...
        management="Monitor serum potassium and renal function closely (before starting, then 1–2 weeks later, and with any dose change). Avoid in patients with CKD or diabetes where hyperkalaemia risk is high.",
    ...
    Interaction(
        ...
        management="Administer fluoroquinolone 2 hours before or 4–6 hours after antacids, iron, zinc, or calcium supplements. Same applies to dairy products.",
    ...
    Interaction(
        ...
        management="Avoid NSAIDs in patients on lithium. Use paracetamol for analgesia. If NSAID unavoidable, reduce lithium dose by 25–50% and monitor levels closely.",
    ...
    Interaction(
        ...
        management="Avoid thiazide diuretics with lithium if possible. If necessary, monitor lithium levels every 2–7 days after diuretic initiation or dose change. Maintain adequate salt and fluid intake.",
    ...
    Interaction(
        ...
        effect="Lithium toxicity",
        management="Monitor lithium levels closely within 1–2 weeks of starting/stopping ACE-I. Dose reduction may be required.",
    ...
    Interaction(
        ...
        severity="SERIOUS",
        mechanism="Pharmacokinetic — fluvoxamine potently inhibits CYP1A2, raising clozapine levels by 3–10 fold",
        effect="Clozapine toxicity: seizures, sedation, hypersalivation, agranulocytosis",
        management="Avoid combination if possible. If used, reduce clozapine dose by 67–75% and monitor levels and clinical status closely.",
        aliases_a=["clozapine", "clozaril"],
    ...
    Interaction(
        ...
        effect="Increased GI bleeding risk (3–15x); particularly upper GI haemorrhage",
...
def print_report(result: dict):
    ...
    if c["MONITOR"]:         print(f"    ⚠️  MONITOR         : {c['MONITOR']}")
    if c["MINOR"]:           print(f"    ℹ️  MINOR           : {c['MINOR']}")
    print(f"\n  ⚕️  For educational use only. Not a substitute for clinical judgment.")
